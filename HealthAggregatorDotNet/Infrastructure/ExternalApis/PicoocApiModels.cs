...
/// <summary>
/// Request structure for Picooc login API.
/// Uses snake_case property names to match the API.
/// </summary>
...
/// <summary>
/// Response from Picooc login API.
/// </summary>
...
/// <summary>
/// Response from Picooc bodyIndexList API.
/// </summary>
...
public class PicoocBodyIndexResponseData
{
    ...
    public int? LastTime { get; set; }  // Nullable - API returns null when no more pages
    public bool Continue { get; set; }
}

/// <summary>
/// Individual body measurement record from Picooc API.
/// Property names match the snake_case API response.
/// </summary>
